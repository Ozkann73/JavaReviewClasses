...
public class MapDemo1 {
    public static void main(String[] args) {
        ...
        personMap.put("5",new Person("2","James",26,"SDET"));
        personMap.put("3",new Person("3","Mike",28,"PO"));
        personMap.put("4",new Person("4","Adam",22,"QA Manager"));
        personMap.put("1",new Person("4","Ali",21,"Architect"));

        // Getting a Set of entries
        Set<Map.Entry<String,Person>>entries= personMap.entrySet();
        // Removing those entries which contains the key 4 or if age of that person greater than 22
